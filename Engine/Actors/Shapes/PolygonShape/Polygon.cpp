...
Polygon::Polygon(const std::size_t& point_count) : Speed(1.f), MaxPosX(-1.f), MaxPosY(-1.f), MinPosX(-1.f), MinPosY(-1.f) {
    CVX.setPointCount(point_count);
}

Polygon::Polygon(const std::size_t& point_count, const float& speed) : Speed(1.f), MaxPosX(-1.f), MaxPosY(-1.f), MinPosX(-1.f), MinPosY(-1.f) {
    CVX.setPointCount(point_count);
    Speed = speed;
}
